...
def fetch_latest_news(limit: int = 5, translate: bool = True) -> list[dict]:
    ...
    if translate:
        ...
        # qilinmaydi, faqat ko'rinadigan sarlavha matni. Har bir so'rov orasida kichik
        # pauza — bir zumda bir nechta tarjima so'rovi yuborish xizmatni band qilib,
        # xato-sahifa qaytarish ehtimolini oshirishi mumkin edi.
        for item in unique:
