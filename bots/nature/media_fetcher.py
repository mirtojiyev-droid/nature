...
# variant sifatida tanlaymiz — standart 3840 = 4K (UHD), lekin .env'dagi
# NATURE_MAX_VIDEO_QUALITY_PX orqali pasaytirilishi mumkin (kam xotirali serverlar
# uchun — bots/nature/quality.py'ga qarang).
