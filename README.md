...
3. Video qidirishda avval `localfootage/` papkasi tekshiriladi — agar u yerda joriy
...
2. Faylni loyihadagi `localfootage/` papkasiga, tavsiflovchi nom bilan joylang — masalan
   `waterfall_night_storm_dramatic.mp4` yoki `aerial_mountain_sunset_cinematic.mp4`
   (batafsil: `localfootage/README.txt`).
...
- **`localfootage/` papkasiga video qo'ydim, lekin ishlatilmayapti** — fayl nomi joriy
