...
Pexels/Pixabay/Wikimedia'dan topilgan kontent sifati (ayniqsa kamdan-kam so'raladigan
...
**Video manba tartibi haqida**: foydalanuvchi (siz) ikkala platformani qo'lda
solishtirib, Pixabay'da vizual jihatdan ancha chiroyli/e'tiborni tortadigan
videolar ko'proq ekanini aniqladingiz — shuning uchun video uchun **Pixabay
birinchi** sinaladi, Pexels ikkinchi (zaxira), Wikimedia Commons uchinchi.
**Muhim texnik cheklov**: Pixabay'ning video API'si — platformaning o'zining
qat'iy chegarasi sifatida — **faqat 1920x1080 (Full HD)gacha** beradi, 4K
(3840x2160) umuman taklif qilmaydi (bu hech qanday sozlama bilan
o'zgartirilmaydi). Agar sifat (piksel soni) ustuvor bo'lsa, buni qaytadan
Pexels-birinchi tartibiga o'zgartirish mumkin — `bots/nature/run.py`dagi
`_video_sources()` funksiyasiga qarang. Rasm uchun tartib o'zgarishsiz
qoldirildi (Pexels birinchi) — Pixabay'ning yuqori sifatli rasm havolasi
(`fullHDURL`, 1920px+) faqat "to'liq API kirish" tasdiqlangan hisoblarda
mavjud, aks holda `largeImageURL` (1280px) ishlatiladi.
